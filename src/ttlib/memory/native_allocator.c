...
{
    /// trace
    tt_trace_d("malloc(%lu) at %s(): %lu, %s", size, func_, line_, file_);
...
{
    /// trace
    tt_trace_d("realloc(%lu) at %s(): %lu, %s", size, func_, line_, file_);
...
{
    /// trace
    tt_trace_d("free(%lu) at %s(): %lu, %s", data, func_, line_, file_);
